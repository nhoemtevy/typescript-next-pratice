...
async function page({params}: ParamProps) {
  ...
  <a href="#">
    <img className="h-60 rounded-t-lg object-cover" src={productDetail.thumbnail} alt="product image" />
  </a>
  ...
  <div className="mt-4 px-5 pb-5">
    <a href="#">
      <h5 className="text-xl font-semibold tracking-tight text-slate-900">${productDetail.title}</h5>
    </a>
